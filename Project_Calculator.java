...
{
    public Frame mainframe; //due to awt package
    public Button b1,b2,b3,b4;  //due to awt package
    public TextField t1,t2; //due to awt package
    public Label lobj;  //due to awt package
    Integer no1,no2;    //integer ghetl karan wrapper class
